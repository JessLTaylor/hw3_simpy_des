...
For the remote repository, make a github repository named HW3_SimPy_DES, then do;

```bash
git remote add origin git@github.com:JessLTaylor/HW3_SimPy_DES.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW3_SimPy_DES	<- Your notebooks and scripts will live in the main project folder
