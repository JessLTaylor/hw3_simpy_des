...
def process_command_line():
    ...
    """
    # Create the parser
    parser = argparse.ArgumentParser(prog='blood_donation_clinic_model', description='Run Blood Donation clinic simulation')

    # Add arguments
    parser.add_argument("--config", type=str, default=None,
                        help="Configuration file containing input parameter arguments and values")

    parser.add_argument("--patient_arrival_rate", default=40, help="patients per hour",
                        type=float)

    parser.add_argument("--num_greeters", default=4, help="number of greeters",
                        type=int)

    parser.add_argument("--num_reg_staff", default=4, help="number of registration staff",
                        type=int)

    parser.add_argument("--num_bd_tech", default=15, help="number of blood draw technicians",
                        type=int)

    parser.add_argument("--num_schedulers", default=4, help="number of schedulers",
                        type=int)
    ...
    parser.add_argument("--scenario", type=str, default=datetime.now().strftime("%Y.%m.%d.%H.%M."),
